        ...
        <div class="row">
            <div class="col-md-6">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Заголовки таблицы организаций</h5>
                    </div>
                            ...
                            >
                                ...
                                @foreach($table_th as $item)
                                    <tr>
                                        <td> {{$i++}}</td>
                                        <td>
                                            <a href="{{route('table_th_edit', ['item->id' => $item->id])}}"
                                            ...
                                            @if(!Auth()->user()->group_id)
                                                <form action="{{route('table_th_delete', ['item->id' => $item->id])}}"
            ...
            <div class="col-md-6">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form action="{{route('table_th_store')}}" method="post">
                            {{ csrf_field() }}
                            <div class="box-body">
                                <div class="form-group">
                                    <label>Название</label>
                                    <input type="text" class="form-control" name="name" required="" placeholder="Заголовок">
                                </div>
                            </div>
